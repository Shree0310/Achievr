            ...
            <Card
                ...
                <div className="flex justify-between space-y-2">
                    ...
                    <div className="flex justify-between items-start space-x-6 text-neutral-500">
                        ...
                        {/* Subtasks icon */}
                        <button 
                            className={`flex items-center space-x-1 hover:bg-neutral-100 dark:hover:bg-neutral-700 rounded p-1 transition-colors ${showSubtasks ? 'bg-blue-100 dark:bg-blue-900/20' : ''}`}
