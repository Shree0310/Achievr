...
const Task = ({ task, id, onTaskUpdate, commentCount = 0 }) => {
            ...
            <Card
                ...
                <div className="flex justify-between space-y-2">
                    ...
                    <div className="flex justify-between items-start space-x-6 text-gray-500">
                        ...
                        {/* Subtasks icon */}
                        <button className="flex items-center space-x-1 hover:bg-gray-700" onClick={handleClick}>
                            <svg className="w-5 h-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-label="subtasks">
