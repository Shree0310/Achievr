    ...
    if (isLoading) {
        return (
            <div className="flex items-center justify-center py-8">
                ...
                <span className="ml-3 text-gray-500 dark:text-gray-400">Loading pull requests...</span>
            </div>
        );
    }
    ...
    if (error) {
        return (
            <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Error Loading Pull Requests</h3>
    ...
    if (pullRequests.length === 0) {
        return (
            <div className="text-center py-8">
                ...
                <p className="text-gray-500 dark:text-gray-400">No GitHub pull requests have been created for this task yet.</p>
            </div>
        );
    }
