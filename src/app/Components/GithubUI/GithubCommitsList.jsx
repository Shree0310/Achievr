    ...
    if (isLoading) {
        return (
            <div className="flex items-center justify-center py-8">
                ...
                <span className="ml-3 text-neutral-500 dark:text-neutral-400">Loading commits...</span>
            </div>
        );
    }
    ...
    if (error) {
        return (
            <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-neutral-900 dark:text-white mb-2">Error Loading Commits</h3>
    ...
    if (commits.length === 0) {
        return (
            <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-neutral-900 dark:text-white mb-2">No Commits Found</h3>
                <p className="text-neutral-500 dark:text-neutral-400">No GitHub commits have been linked to this task yet.</p>
            </div>
        );
    }
