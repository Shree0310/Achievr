  ...
  return (
    <div className="bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm">
      ...
      <div className="flex items-center space-x-3 mb-6">
        ...
        <div>
          <h3 className="text-lg font-semibold text-neutral-900 dark:text-white">Create GitHub Branch</h3>
          <p className="text-sm text-neutral-500 dark:text-neutral-400">Link this task to a new GitHub branch</p>
        </div>
      </div>
      ...
      <div className="bg-neutral-50 dark:bg-neutral-700/50 rounded-lg p-4 mb-6">
        <div className="flex items-start space-x-3">
          ...
          <div className="flex justify-center pt-2">
            <p className="text-sm text-neutral-600 dark:text-neutral-300 truncate font-bold">{taskToEdit.title}</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-5">
        <div>
          <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2" htmlFor="repository">
        ...
        <div>
          <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2" htmlFor="baseBranch">
            <span className="flex items-center space-x-2">
        ...
        <button
          ...
          className="w-full flex items-center justify-center space-x-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-neutral-400 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-colors duration-200"
        >
          {creating ? (
            <>
        ...
        <div className={`mt-6 p-4 rounded-lg border ${
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              {result.branch && (
                <div className="mt-3 p-3 bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-600">
