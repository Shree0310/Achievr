            ...
            {isCheckingAuth ? (
                ...
                <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-2xl shadow-xl transform transition-all hover:scale-[1.01]">
                    ...
                    <div className="flex flex-col items-center space-y-4">
                        ...
                        <h1 className="text-3xl font-bold text-neutral-800">Welcome to Achievr</h1>
                        <p className="text-center text-neutral-600">Your personal task management and productivity companion</p>
                    </div>
