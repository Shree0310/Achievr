    ...
    async function getSession() {
      try {
        ...
        if (data.session?.user) {
          ...
          console.log(
            "User authenticated, redirecting to board:",
          ...
          <div className="flex flex-col items-center space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-gray-600">
                Please sign in to access your tasks and cycles
              </p>
            </div>
            ...
            <div className="w-full space-y-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <Link
                  href="/auth"
                  className="flex-1 inline-flex items-center justify-center px-6 py-3 text-base font-medium text-gray-700 bg-white border dark:border-neutral-600 border-neutral-200 rounded-lg hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all">
                  Create Account
                </Link>
              </div>
            </div>
    ...
    <div className="h-screen w-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-screen max-h-screen overflow-hidden">
        ...
        <div className="flex-1 overflow-hidden">
          <Stages onTaskUpdate={undefined} userId={user.id}  />
        </div>
      </div>
    </div>
  );
